...
numero_casos(EWR$wind_gust)
numero_casos(EWR$wind_speed)
numero_casos(LGA$wind_gust)
numero_casos(LGA$wind_speed)
numero_casos(JFK$wind_gust)
numero_casos(JFK$wind_speed)
```
